                ...
                <div class="col-sm-4 col-xl-3 col-lg-4">
                    <div class="card custom-card">
                        <div class="card-body dash1">
                            ...
                            <div>
                                <?php
                                    $all_count = $conn->query("SELECT COUNT(ID) as allcount FROM Students WHERE University_ID = 49");
                                    $records = mysqli_fetch_assoc($all_count);
                                    $totalRecords = $records['allcount'];
                                ?>
                ...
                <div class="col-sm-4 col-xl-3 col-lg-4">
                    <div class="card custom-card">
                        <div class="card-body dash1">
                            ...
                            <div>
                                <?php
                                    $all_count = $conn->query("SELECT COUNT(ID) as allcount FROM Sub_Courses WHERE University_ID = 49");
                                    $records = mysqli_fetch_assoc($all_count);
                                    $totalRecords = $records['allcount'];
                                ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered text-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <?php 
                                            $centers = $conn->query("SELECT * FROM Users WHERE Role = 'Center' ");
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered text-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <?php 
                                            $centers = $conn->query("SELECT * FROM Students WHERE University_ID = 48");
                                            if($centers->num_rows>0){
                                            while ($row = $centers->fetch_assoc()) {
                                        ?>
                                            <tr>
