...
// echo "SELECT COUNT(Wallets.ID) as filtered FROM Wallets LEFT JOIN Universities ON Wallets.University_ID = Universities.ID LEFT JOIN Students ON Wallets.Added_For = Students.ID WHERE Type = 1 OR Type = 2 $university_query $searchQuery $role_query"; die;
